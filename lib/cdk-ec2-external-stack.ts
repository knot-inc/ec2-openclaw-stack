...
export class CdkEc2ExternalStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const role = new iam.Role(this, "InstanceRole", {
      roleName: "OpenClawExternalInstanceRole",
    ...
    const instance = new ec2.Instance(this, "clawInstance1", {
      vpc,
      vpcSubnets: {
        subnetType: ec2.SubnetType.PUBLIC,
      },
      ...
      machineImage: ec2.MachineImage.genericLinux({
        "us-east-2": "ami-0b0b78dcacbab728f", // Amazon Linux 2023 - fixed version
      }),
      securityGroup,
      role,
